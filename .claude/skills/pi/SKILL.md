...
**Default voice:** pi inherits Justin's base voice from `~/AGENTS.md` (generated by install.sh from `agent-skills/rules.d/`); the full `style` skill carries the per-artifact detail. No pi-specific extension.
