...
Naming is really important. It's how we end up with the same mental model of the system and the code. Carefully consider what the right name is for anything that matters: interfaces, important methods, modules, databases, columns. I like names that are self-descriptive, straightforward, and intuitive, and that match the abstraction layer: a logging package the whole codebase uses is just logger, while an interface for one specific branch of the code gets a specific name. Let's make sure we agree on the important ones. If you're unsure, just ask me. We can work it out together.
