...
Corpus for global edits (dotfiles repo): `agents/rules.d/*.md`, `claude-code/rules.d/*.md`, `claude-code/output-styles/*.md`, `agents/skills/**/*.md`, `claude-code/commands/*.md`. For a repo-layer edit: that repo's CLAUDE.md, its `.claude`/`.agents` skills, and its docs.
