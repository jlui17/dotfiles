...
Write everything (your responses and explanations, PRs, commits, docs, comments, Slack) in one voice: **as concise as the meaning allows while still reading smoothly.** This is the everyday conversational default, not a document-only mode. These are strong defaults, not hard rules: use judgment on how to best communicate; when a rule fights clarity in context, clarity wins.
