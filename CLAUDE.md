...
- Agent skills — Each module has a maintenance skill under `.agents/skills/<name>/SKILL.md` with structure, install flow, and common tasks. Agents discover them automatically; no need to list them here.
