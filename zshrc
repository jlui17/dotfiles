...
if command -v brew &>/dev/null; then
  alias update_pkgs='brew update && brew upgrade && mise up && bunx skills update -g && zinit update && zinit cclear && rm -rf "${XDG_CACHE_HOME:-$HOME/.cache}/zsh-eval" && update_t3'
  ...
  alias update_pkgs='omarchy update -y && bunx skills update -g && zinit update && zinit cclear && rm -rf "${XDG_CACHE_HOME:-$HOME/.cache}/zsh-eval" && update_t3'
